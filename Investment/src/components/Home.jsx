...
//   return (
//     <div className="container-fluid p-3" style={{ background: "#0d1117", minHeight: "100vh" }}>
...
//           <button className="nav-link active bg-dark text-warning fw-bold border-secondary">
//             Discover
//           </button>
//         </li>
//         <li className="nav-item">
//           <button className="nav-link bg-dark text-light border-secondary">Following</button>
//         </li>
//         <li className="nav-item">
//           <button className="nav-link bg-dark text-light border-secondary">Campaign</button>
//         </li>
//         <li className="nav-item">
//           <button className="nav-link bg-dark text-light border-secondary">Announcements</button>
//         </li>
//       </ul>
...
//           <b>Imdad 02</b>
//           <span className="text-muted small">14h ago</span>
//         </div>

//         <p className="mt-2">
//           I lost all my money 😭😭😭 Should I hold or sell?
//         </p>

//         <img
//           src="https://dummyimage.com=${image}/500x300/cccccc/000000"
//           alt="post"
...
//     <p className="small text-muted mb-2">Auto-updated from your live market feed</p>
...
//     <p className="small text-muted">Auto updated live</p>
...
//     <p className="small">• Earn cashback on trading</p>
...
//   <div className="card bg-dark border-secondary text-light p-3 rounded-4 shadow">
//     <b>📢 Latest Market Announcements</b>
//     <p className="small text-muted">Auto update</p>

//     <ul className="list-group list-group-flush bg-dark">
//       <li className="list-group-item bg-dark text-light">
//         SOL network upgrade planned today.
//       </li>
//       <li className="list-group-item bg-dark text-light">
